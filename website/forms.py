...
class EventForm(FlaskForm):
    ...
    headliner = StringField('Headlining organiser', validators=[
        InputRequired(message='Your event must have a headlining organiser'), Length(min=1, max=40, message='Headliner cannot be more than 40 characters'), check_field_length])
...
class EditEventForm(FlaskForm):
    ...
    headliner = StringField('Headlining organiser', validators=[Length(
